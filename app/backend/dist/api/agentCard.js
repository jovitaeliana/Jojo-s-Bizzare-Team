 ...
 */
function loadAgentCard(agentType) {
    try {
        const cardPath = path.join(__dirname, "../../public/agents", agentType, "card.json");
 ...
 */
function updateCardUrls(card, req) {
 ...
 */
router.get("/agents/buyer/card.json", (req, res) => {
 ...
 */
router.get("/agents/seller/card.json", (req, res) => {
 ...
 */
router.options("/.well-known/agent-card.json", (req, res) => {
    res.setHeader("Access-Control-Allow-Origin", "*");
    res.setHeader("Access-Control-Allow-Methods", "GET, OPTIONS");
    res.setHeader("Access-Control-Allow-Headers", "Content-Type, Authorization");
    res.status(204).send();
});
router.options("/agents/:agentType/card.json", (req, res) => {
    res.setHeader("Access-Control-Allow-Origin", "*");
    res.setHeader("Access-Control-Allow-Methods", "GET, OPTIONS");
    res.setHeader("Access-Control-Allow-Headers", "Content-Type, Authorization");
    res.status(204).send();

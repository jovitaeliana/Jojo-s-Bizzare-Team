 ...
 */
export function createProductSelectionPrompt(
  userRequest: string,
  products: Product[]
): string {
 ...
 */
export function createNegotiationPrompt(
  product: Product,
  userBudget?: number
): string {
 ...
 */
export function createCounterOfferEvaluationPrompt(
  product: Product,
 ...
 */
export function createDeliveryConfirmationPrompt(
  product: Product,
  sellerMessage: string,
  trackingInfo?: string
): string {

 ...
 */
export function createOfferEvaluationPrompt(
  listing: Listing,
  offer: BuyerOffer
): string {
 ...
 */
export function createCounterOfferResponsePrompt(
  listing: Listing,
 ...
 */
export function createShipmentConfirmationPrompt(
  listing: Listing,
  buyerAddress: string,
 ...
 */
export function createListingOptimizationPrompt(
  title: string,
  description: string,
  price: number,
  currency: string,
 ...
 */
export function createDisputeResolutionPrompt(
  listing: Listing,

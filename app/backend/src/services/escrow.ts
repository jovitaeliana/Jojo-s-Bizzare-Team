...
export class EscrowService {
  ...
  constructor() {
    ...
    this.client.setOperator(
      AccountId.fromString(this.operatorAccountId),
   ...
   */
  async createEscrow(buyerAddress: string, sellerAddress: string): Promise<string> {
  ...
  async confirmShipment(
    ...
    try {
      ...
      sellerClient.setOperator(
        ...
        PrivateKey.fromStringECDSA(sellerKey)
      );
   ...
   */
  async getEscrowState(escrowAddress: string): Promise<EscrowDetails> {
   ...
   */
  private toContractId(escrowAddress: string): ContractId | string {

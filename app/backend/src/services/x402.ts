...
export interface X402PaymentRequest {
  ...
  to: string;                // Recipient account ID (0.0.x)
  amount: string;            // Amount in smallest unit
  currency: string;          // "HBAR" or token ID (e.g., "0.0.429274" for USDC)
...
export class X402Service {
  ...
  private readonly USDC_TOKEN_ID = "0.0.429274";
